...
import br.com.alessandro.aws_project01.model.Invoice;
import br.com.alessandro.aws_project01.model.UrlResponse;
import br.com.alessandro.aws_project01.repository.InvoiceRepository;
...
public class InvoiceController {
    ...
    public ResponseEntity<UrlResponse> createInvoiceUrl() {
        ...
        GeneratePresignedUrlRequest generatePresignedUrlRequest = new GeneratePresignedUrlRequest(bucketName, processId)
                .withMethod(HttpMethod.PUT)// limitando o acesso à url apenas pela operação PUT conforme confiurado no projeto
