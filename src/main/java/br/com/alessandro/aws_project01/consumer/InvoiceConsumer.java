package br.com.alessandro.aws_project01.consumer;

import br.com.alessandro.aws_project01.model.Invoice;
import br.com.alessandro.aws_project01.model.SnsMessage;
...
public class InvoiceConsumer {
    ...
    public void processInvoiceNotification(S3EventNotification s3EventNotification) throws IOException {
        ...
        for (S3EventNotification.S3EventNotificationRecord s3EventNotificationRecord : s3EventNotification.getRecords()) {
            ...
            amazonS3.deleteObject(bucketName, objectKey);//opcional
        }
    }
